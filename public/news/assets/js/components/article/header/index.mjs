  ...
  return `
    <header style="display: flex; align-items: center; margin-bottom: 10px;">
      <div style="margin-right: 30px;">
        <a target="_blank" rel="noreferrer noopener" href="${window.VK_LINK}/${123}">${Logo()}</a>
      </div>
      <div>
        <div>
          <a style="text-decoration: none;" target="_blank" rel="noreferrer noopener" href="${window.VK_LINK}/${123}">TFC-survival.ru</a>
        </div>
